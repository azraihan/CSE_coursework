...
bool ScopeTable::insert(const string &name, const string &type, const std::string &varDataType, const std::string &functionReturnType, int functionArgumentNumber, std::vector<std::string>parameterTypes, bool isGlobal, int stackBasePointerOffset)
{
    ...
    // Create new symbol
    SymbolInfo *newSymbol = new SymbolInfo(name, type, varDataType, functionReturnType, functionArgumentNumber, parameterTypes, isGlobal, stackBasePointerOffset);
